...
public class Skates implements Powerup{
    ...
    public Skates(int number, SpriteBatch batch, Grid grid, int startx, int starty, Overlord overlord) {

        System.out.println("New skates created!");
        ...
        this.skatesprite = new Sprite(this.atlas.findRegion("skates"));
        ...
        this.collectsound = Gdx.audio.newSound(Gdx.files.internal("sounds/collectedsound.wav"));
    ...
    public void Move() {
        ...
        this.grid.gridlist[this.currentx][this.currenty].sprite = this.skatesprite;
    }
