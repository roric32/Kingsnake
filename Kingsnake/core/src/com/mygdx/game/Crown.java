...
public class Crown implements Powerup{
    ...
    public Crown(int number, SpriteBatch batch, Grid grid, int startx, int starty, Overlord overlord) {

        System.out.println("New Crown created!");
        ...
        this.crownsprite = new Sprite(this.atlas.findRegion("crown"));
        ...
        this.collectsound = Gdx.audio.newSound(Gdx.files.internal("sounds/fanfare.mp3"));
